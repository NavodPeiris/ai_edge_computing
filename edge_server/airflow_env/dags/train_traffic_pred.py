...
def train_model(data, location):
    ...
    os.makedirs(f"/opt/airflow/dags/traffic_pred_models/{location}", exist_ok=True)

    # Save the scaler
    joblib.dump(scaler, f"/opt/airflow/dags/traffic_pred_models/{location}/scaler.pkl")
    ...
    model_checkpoint = ModelCheckpoint(f'/opt/airflow/dags/traffic_pred_models/{location}/model.h5', monitor='val_loss', save_best_only=True)
    ...
    best_model = tf.keras.models.load_model(f'/opt/airflow/dags/traffic_pred_models/{location}/model.h5')
